...
const srjModules = import.meta.glob(
  "../node_modules/@tsci/tscircuit.dataset-srj20-partial-bga-breakouts/circuits/sample*/sample*.circuit.simple-route.json",
  {
    eager: true,
    import: "default",
  },
...
export default function DatasetSrj20Fixture() {
